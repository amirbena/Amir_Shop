...
function default_1() {
    return __awaiter(this, void 0, void 0, function () {
        var regularPath, absoultePath, connection, ex_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, mongoose_1.default.connect(process.env.DB_PATH, { useNewUrlParser: true, useUnifiedTopology: true, useCreateIndex: true, useFindAndModify: false })];
                case 2:
                    connection = _a.sent();
