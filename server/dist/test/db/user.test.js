...
mocha_1.describe("User Model testing", function () {
    ...
    mocha_1.describe("Testing POST /:", function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, database.Services.UserService.createUser(object, jwtKey)];
                    case 1:
                        result = _a.sent();
                        chai_1.expect(result.status).to.be.equal(HTTP_Enum_1.default.BAD_REQUEST);
                        return [2 /*return*/];
                }
            });
        }); });
